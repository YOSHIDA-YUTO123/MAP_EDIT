...
{
	// オーディオデータのクリア
	memset(&m_apDataAudio, NULL, sizeof(m_apDataAudio));

	// オーディオソースのクリア
	memset(&m_apSourceVoice, NULL, sizeof(m_apSourceVoice));

	// オーディオサイズのクリア
	memset(&m_aSizeAudio, NULL, sizeof(m_aSizeAudio));

	// マスターボイスのクリア
	memset(&m_pMasteringVoice, NULL, sizeof(m_pMasteringVoice));

	// オーディオインターフェースのクリア
	memset(&m_pXAudio2, NULL, sizeof(m_pXAudio2));
}
//===============================================
// デストラクタ
//===============================================
